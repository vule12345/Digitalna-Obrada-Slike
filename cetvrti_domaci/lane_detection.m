function [first_lane, second_lane] = lane_detection( frame )
%LANE_DETECTION detect where road lines on input frame are.
%   Input frame is a RGB image, outputs of function are two 4 element
%   arrays represeting each lane with 2 (x,y) points. Lines can be yellow
%   or white, solid or broken.
...
% Saving to output
first_lane = [bot_left, top_left];

second_lane = [bot_rigt, top_right];
