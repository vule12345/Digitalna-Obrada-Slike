...
% % set(gcf, 'Name', 'Rezultat uklanja koriscenjem krst filtra');
% % disp('Third part of homework ends here')
>>>>>>> b93f7d49534cc35a7c6f64129c2aad405b50930b
...
% hold on
% plot(K, PSNR_S_51)
% xlabel('Velicina prozora K','Interpreter','LaTex','FontSize',16)
% ylabel('PSNR','Interpreter','LaTex','FontSize',16)
% title('Zavisnost PSNR-a od parametra K i S','Interpreter','LaTex','FontSize',16)
% legend('S = 15', 'S = 33', 'S = 51')

% Displaying result of non local means funcion for chosen parameters
figure
imshow(result_K_5_S_15);
set(gcf, 'Name', 'Rezultat non local means funnkcije za K=5 i S=15');
