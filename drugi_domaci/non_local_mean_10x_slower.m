...
close all
clc
% This script does same thing ase non_local_mean funcion but 10 times
% slower, because it uses S search region loops.
...
for global_x = pad+1: pad+M
    ...
    for global_y = pad+1: pad+N
        ...
        S_end_x = global_x + half_s; 
        S_end_y = global_y + half_s; 
